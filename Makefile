...
javac:
	javac -cp $(ANTLR_CP):./build/com/benparetzky/minijava-jasmin-sugar -d $(DEST_DIR) $(DEST_DIR)src/minijavaLexer.java $(DEST_DIR)src/minijavaParser.java src/com/benparetzky/minijavajasminsugar/MinijavaCompiler.java
